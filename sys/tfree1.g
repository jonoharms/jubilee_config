...
G53 G0 X277.0 Y280 F12000      ; Rapid to the back of the post. Stay away from the tool rack so we don't collide with tools.
...
G53 G1 Y319.1 F6000            ; Controlled move to the park position with tool-1. (park_x, park_y)
