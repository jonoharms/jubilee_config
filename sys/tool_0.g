	; Toolboard 20 Tool 0
	M308 S1 P"20.temp0" Y"thermistor" T100000 B4725 C7.06e-8 A"T0"		; Thermistor for toolboard T0 extruder heater
	M950 H1 C"20.out0" T1										; Heater for extruder out toolboad tool 0
	M143 H1 S300
	;M307 H1 A587 C235 D5.5 V24.1 
    M307 H1 A250 C130 D5.5 V24
	;== Fans ===============================
    ...
    M950 F2 C"20.out2" ; Creates fan 0 on pin out2 (print cooling fan)
